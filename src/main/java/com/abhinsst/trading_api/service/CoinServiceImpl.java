...
import com.abhinsst.trading_api.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService {
  ...
  public String getMarketChart(String coinId, int days) throws Exception {
    String url = "https://api.coingecko.com/api/v3/coins/" + coinId + "market_chart?vs_currency=usd$day=" + days;
    RestTemplate restTemplate = new RestTemplate();
    try {
      HttpHeaders headers = new HttpHeaders();
      HttpEntity<String> entity = new HttpEntity<String>("parameters", headers);
  ...
  @Override
  public String getCoinDeails(String coinId) throws Exception {
    ...
    try {
      ...
      coin.setHigh24h(marketData.get("hight_24h").get("usd").asDouble());
