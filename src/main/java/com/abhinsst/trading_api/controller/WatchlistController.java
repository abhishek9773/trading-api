...
import com.abhinsst.trading_api.service.WatchlistService;
...
public class WatchlistController {
  ...
  // createWatchlist(@RequestHeader("Authorization") String jwt) throws Exception{
  // User user = userService.findUserProfileByJwt(jwt);
  ...
  public ResponseEntity<Coin> addItemWatchlist(@RequestHeader("Authorization") String jwt, @PathVariable String coinId)
      throws Exception {
